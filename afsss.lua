...
local function createFluentUI()
    ...
    do
        ...
        Tabs.Defense:AddButton({
            ...
            Description = "Save current position as spawn point",
            Callback = function()
        ...
        local autoMeteorToggle = Tabs.Defense:AddToggle("AutoMeteor", {
            ...
            Description = "Automatically farm meteors across all worlds",
            Default = false
        })
        ...
        local autoDefenseToggle = Tabs.Defense:AddToggle("AutoDefense", {
            ...
            Description = "Automatically attack enemies in Titan world",
            Default = false
        })
